...
class SophiaG(Optimizer):
    ...
    @torch.no_grad()
    def step(self, closure=None, bs: int=5120):
        loss = None
...
def _single_tensor_sophiag(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        param.mul_(1 - lr * weight_decay)  # Perform stepweight decay
        exp_avg.mul_(beta1).add_(grad, alpha=1 - beta1)  # Decay the first and second moment running average coefficient
